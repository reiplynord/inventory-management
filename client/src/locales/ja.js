export default {
  ...
  restocking: {
    title: '補充',
    description: '予算を設定し、需要予測に基づいて補充注文を提出します',
    budget: '予算',
    leadTime: '配達リードタイム',
    days: '日',
    ...
    totalSpend: '合計支出',
    remaining: '残り',
    nothingToRestock: '予測需要を下回る品目はありません — 補充は不要です。',
    noItemsForLeadTime: 'このリードタイムで対応可能な品目はありません。より長いリードタイムをお試しください。',
    successToast: '補充注文を提出しました。注文タブで確認できます。',
    viewInOrders: '注文で確認',
    table: {
      sku: 'SKU',
      itemName: '品目名',
