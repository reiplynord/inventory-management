export default {
  ...
  restocking: {
    ...
    remaining: 'Remaining',
    nothingToRestock: 'No items below forecasted demand — nothing to restock.',
    noItemsForLeadTime: 'No items available with this lead time. Try a longer lead time.',
    successToast: 'Restock order placed. View it in Orders.',
